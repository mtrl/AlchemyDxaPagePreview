...
namespace Alchemy.Plugins.DxaPreview.Config
{
    ...
    /// and references.
    /// </summary>
    public class DxaPreviewResourceGroup : ResourceGroup
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public DxaPreviewResourceGroup()
        {
            // When adding files you only need to specify the filename and not full path
            AddFile("DxaPreviewCommand.js");
            AddFile("DxaPreviewSettingsCommand.js");

            AddFile("DxaPreview.css");

            // When referencing commandsets you can just use the generic AddFile with your CommandSet as the type.
            AddFile<DxaPreviewCommandSet>();
